                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group me-2">
                            <a href="{{ route('product.edit', $data->id) }}" class="btn btn-primary btn btn-outline-primar btn-sm">Ubah</a>
                            <a href="/hapusproduct/{{ $data->id }}" class="btn btn-danger btn btn-outline-primar btn-sm">Hapus</a>
                        </div>
                    </td>
                </tr>
            @endforeach
