            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Edit Deliveries Data</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Deliveries / Edit</li>
                        </ol>
                        <!-- <div class="row"> -->
                        <!-- Table -->
                ...
                <div class="mb-3 ms-3 me-3">
                    ...
                    <select name="order_id" id="order_id" class="form-control" required>
                     ...
                     <div class="mb-3 ms-3 me-3">
                        ...
                        <input type="date" name="shipping_date" id="shippingdate" class="form-control" placeholder="Tanggal Deliveries" aria-label="tanggal" value="{{$deliveries->shipping_date ?? old('shipping_date')}}" required>
                     </div>
                     <div class="mb-3 ms-3 me-3">
                     ...
                     <div class="mb-3 ms-3 me-3">
                        <label type="deliveries"class="form-label" required>Payment Method</label>
                        <select name="status" class="form-control" id="status" value= required>-- Pilih Status --
                            <option value="{{$deliveries->status ?? old('status')}}">"{{$deliveries->status ?? old('status')}}"</option>
