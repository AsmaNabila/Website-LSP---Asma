            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Deliveries Data</h1>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <a href="{{route('deliveries.create')}}" class="btn btn-primary mb-2">
                                Tambah
                            </a>
                        <table class="table table-hover table-bordered table-stripped" id="deliveries">
                        <thead>
                        <tr>
                            <th>No.</th>
                            <th>Order Id</th>
                      ...
                      <td>
                        ...
                        {{$idx + 1 . ". "}}
                            ...
                            <div class="btn-group me-2">
                                <a href="{{route('deliveries.edit',$data)}}" class="btn btn-primary btn btn-outline-primar btn-sm">Ubah</a>
                                <a href="/hapusdeliveries/{{$data->id}}" class="btn btn-danger btn btn-outline-primar btn-sm">Hapus</a>
                            </div>
                            </td>
