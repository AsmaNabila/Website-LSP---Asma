            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Create Deliveries Data</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Deliveries / Create</li>
                        </ol>
                        <!-- <div class="row"> -->
                        <!-- Table -->
          ...
          <div class="card mb-6">
            ...
            <!-- FORM -->
              <div class="table-responsive p-0">
                ...
                <form action='/insertdatadeliveries' method="post" id="orders">
                  @csrf
                  <div class="mb-3 ms-3 me-3">
                     ...
                     <div class="mb-3 ms-3 me-3">
                        ...
                        <input type="date" name="shipping_date" id="shippingdate" class="form-control" placeholder="Tanggal Deliveries" aria-label="password" required>
                     </div>
                     <div class="mb-3 ms-3 me-3">
                        <label type="nama" class="form-label">Tracking Code</label>
                        <input type="text" name="tracking_code" id="tcode" class="form-control"  aria-label="tcode" required>
                     </div>
                     <div class="mb-3 ms-3 me-3">
                        <label type="status"class="form-label" required>Status</label>
                        <select name="status" class="form-control" id="status" required>-- Pilih Status --
