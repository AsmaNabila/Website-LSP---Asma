            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Create Customers</h1>
          ...
          <div class="card mb-6">
            ...
            <!-- FORM -->
              <div class="table-responsive p-0">
                ...
                <form action="/insertdatacustomers" method="POST" id="customers">
                  @csrf
                    <div class="mb-3 ms-3 me-3">
                        <label type="nama" class="form-label">Nama Customer</label>
                        <input type="text" name="name" id="nama" class="form-control" placeholder="masukkan nama customer" aria-label="password" required>
                     </div>
                     <div class="mb-3 ms-3 me-3">
                        <label type="nama" class="form-label">Email</label>
                        <input type="email" name="email" id="date" class="form-control"  aria-label="date" placeholder="masukkan email customer" required>
                     </div>
                     <div class="mb-3 ms-3 me-3">
                        <label type="password"class="form-label">Password</label>
                        <input type="password" id="password" name="password" class="form-control" placeholder="masukkan password anda" aria-label="totalamount" required>
                     </div>
                     <div class="mb-3 ms-3 me-3">
                        <label type="phone"class="form-label">Nomor Telephone</label>
                        <input type="number" id="status" name="phone" class="form-control" placeholder="masukkan nomor telephone anda" aria-label="status" required>
                     </div>
                     <div class="mb-3 ms-3 me-3">
                        <label type="alamat1" class="form-label">Alamat Ke 1</label>
                        <textarea rows="5" name="address1" id="address1" class="form-control" placeholder="second address" aria-label="name" required></textarea>
                     </div>
                     <div class="mb-3 ms-3 me-3">
                        <label type="alamat1" class="form-label">Alamat Ke 2</label>
                        <textarea rows="5" name="address2" id="address2" class="form-control" placeholder="second address" aria-label="name" required></textarea>
                     </div>
                     <div class="mb-3 ms-3 me-3">
                        <label type="alamat1" class="form-label">Alamat Ke 3</label>
                        <textarea rows="5" name="address3" id="address2" class="form-control" placeholder="second address" aria-label="name" required></textarea>
                     </div>
