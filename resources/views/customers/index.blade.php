    ...
    <div id="layoutSidenav">
        ...
        <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Customers Data</h1>
                      ...
                      <td>
                        ...
                        {{$idx + 1 . ". "}}
                            ...
                            <div class="btn-group me-2">
                                <a href="{{route('customers.edit',$data)}}" class="btn btn-primary btn btn-outline-primar btn-sm">Ubah</a>
                                <a href="/hapuscustomers/{{$data->id}}" class="btn btn-danger btn btn-outline-primar btn-sm">Hapus</a>
                            </div>
                            </td>
