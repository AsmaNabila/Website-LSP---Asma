            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Orders Details Data</h1>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <a href="{{route('order_details.create')}}" class="btn btn-primary mb-2">
                                Tambah
                            </a>
                        <table class="table table-hover table-bordered table-stripped" id="order_details">
                        <thead>
                        <tr>
                            <th>No.</th>
                            <th>Product Id</th>
