            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Edit Order Details</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Order Details / Edit</li>
                        </ol>
                        <!-- <div class="row"> -->
                        <!-- Table -->
          ...
          <div class="card mb-6">
            ...
            <!-- FORM -->
              <div class="table-responsive p-0">
                ...
                <form action='/insertdataodetails' method="post" id="orderdetails">
                  @csrf
                    <div class="mb-3 ms-3 me-3">
                        <label type="nama" class="form-label">Product Id</label>
                        <input type="number" name="product_id" id="productid" class="form-control" placeholder="masukkan nama anda" aria-label="password">
                     </div>
                     <div class="mb-3 ms-3 me-3">
                        <label type="nama" class="form-label">Order Id</label>
                        <input type="number" name="order_id" id="orderid" class="form-control" placeholder="masukkan nama anda" aria-label="password">
                     </div>
                     <div class="mb-3 ms-3 me-3">
                        <label type="nama" class="form-label">Quantity</label>
                        <input type="number" name="quantity" id="quantity" class="form-control"  aria-label="quantity">
                     </div>
                     <div class="mb-3 ms-3 me-3">
                        <label type="subtotal"class="form-label">Subtotal</label>
                        <input type="number" id="subtotal" name="subtotal" class="form-control" aria-label="subtotal">
                     </div>
                     <div class="row ms-3 me-3 justify-content-end">
                            <div class="col-3">
                                <a href="{{ route('order_details.index') }}" class="btn btn-danger">Cancel</a>
