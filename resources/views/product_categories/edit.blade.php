            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Edit Product Categories</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Product Categories / Edit</li>
                        </ol>
                        <!-- <div class="row"> -->
                        <!-- Table -->
 <!-- Table -->
          ...
          <div class="card mb-4">
            ...
            <!-- FORM -->
              <div class="table-responsive p-0">
                ...
                <form action="{{route('product_categories.update', $product_categories->id)}}" method="POST" id="productcategories">
                @method('PUT')
                @csrf
                <div class="mb-3 ms-3 me-3">
                        <label type="categoryname" class="form-label">Category Name</label>
                        <input type="text" name="category_name" id="categoryname" class="form-control" placeholder="Masukan Category Product Terbaru" aria-label="productcategory" value="{{$product_categories->category_name ?? old('category_name')}}" required>
                </div>
                <div class="row ms-3 me-3 justify-content-end">
                <div class="col-3">
                    <a href="{{ route('product_categories.index') }}" class="btn btn btn-danger">Cancel</a>
