        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Create Product Categories</h1>
            ...
            <!-- FORM -->
              <div class="table-responsive p-0">
                ...
                <form action='/insertdatapcategory' method="POST" id="productcategories">
                  @csrf
                    <div class="mb-3 ms-3 me-3">
                     ...
                     <div class="row ms-3 me-3 justify-content-end">
                            <div class="col-3">
                                <a href="{{ route('product_categories.index') }}" class="btn btn-danger">Cancel</a>
