            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Product Categories Data</h1>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <a href="{{route('product_categories.create')}}" class="btn btn-primary mb-2">
                                Tambah
                            </a>
                            <div class="card">
    <div class="card-body overflow-auto">
        <table class="table table-hover table-bordered" id="pcategory">
            <thead>
                <tr>
                      ...
                      <td>
                        ...
                        {{$idx + 1 . ". "}}
                            ...
                            <div class="btn-group me-2">
                                <a href="{{ route('product_categories.edit', $data) }}" class="btn btn-primary btn btn-outline-primar btn-sm">Ubah</a>
                                <a href="/hapuspcategory/{{$data->id}}" class="btn btn-danger btn btn-outline-primar btn-sm">Hapus</a>
                            </div>
                            </td>
                            <!-- <td class="align-middle text-center text-sm"> 
                              <span class="btn btn-danger btn btn-outline-primar btn-sm">Edit</span>
                              <span class="btn btn-primary btn btn-outline-primar btn-sm">Delete</span>
                           </td> -->
                    @endforeach
                  </tbody>
                    </table>
        ...
        $('.delete_category').click(function(e){
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    // Redirect ke URL untuk menghapus kategori produk
                    window.location = "/hapuspcategory/" + id;
                }
            })
        });
    });
