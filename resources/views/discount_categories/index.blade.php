            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Discount Categories</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Discount Data</li>
                        </ol>
                        <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <a href="{{route('discount_categories.create')}}" class="btn btn-primary mb-2">
                                Tambah
                            </a>
                            <div class="card">
    <div class="card-body overflow-auto">
        <table class="table table-hover table-bordered" id="dcategory">
            <thead>
                <tr>
                      ...
                      <td>
                        ...
                        {{$idx + 1 . ". "}}
                            ...
                            <div class="btn-group me-2">
                                <a href="{{route('discount_categories.edit',$data)}}" class="btn btn-primary btn btn-outline-primar btn-sm">Ubah</a>
                                <a href="/hapusdcategory/{{$data->id}}" class="btn btn-danger btn btn-outline-primar btn-sm">Hapus</a>
                            </div>
                            </td>
