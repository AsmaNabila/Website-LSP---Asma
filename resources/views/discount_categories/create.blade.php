        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Create Discount Categories</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Discount Categories / Create</li>
                        </ol>
                        <div class="row">
                             <!-- Table -->
            ...
            <!-- FORM -->
              <div class="table-responsive p-0">
                ...
                <form action='/insertdatadcategory' method="POST" id="discountcategory">
                  @csrf
                    <div class="mb-3 ms-3 me-3">
                        <label type="categoryname" class="form-label">Category Name</label>
                        <input type="text" name="category_name" id="categoryname" class="form-control" placeholder="Masukan Category Product" aria-label="productcategory" required>
                     </div>
                     <div class="row ms-3 me-3 justify-content-end">
                            <div class="col-3">
                                <a href="{{ route('discount_categories.index') }}" class="btn btn-danger">Cancel</a>
