...
<head>
    ...
    <title>Payments | Asma's Bakery</title>

    <!-- Link Css -->
    <link href="{{ asset('css/stylecheckout.css') }}" rel="stylesheet">
</head>
<!-- Favicon-->
...
<path d="M3 13.4597C3 17.6241 6.4742 21 10.7598 21C14.0591 21 16.8774 18.9993 18 16.1783C17.1109 16.5841 16.1181 16.8109 15.0709 16.8109C11.2614 16.8109 8.17323 13.8101 8.17323 10.1084C8.17323 8.56025 8.71338 7.13471 9.62054 6C5.87502 6.5355 3 9.67132 3 13.4597Z" stroke="#1B1B1B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
  ...
  <form action="/insertdatacheckout" method="POST" id="frmUser">
        @csrf 
        <label for="name">Order Id</label>
            <input type="text" id="name" name="order_id" placeholder="Here to Put your Id" required/>
        <br>
        ...
        <label for="expiry">Metode Pembayaran</label>
            <input class="text" name="payment_method" id="payment_method" type="text" required placeholder="Transer Or Cash"/>
            <br>
            </div>
            <div class="security">
        <label for="amount">Total Pembelian</label>
            <input type="number" minlength="3" maxlength="4" id="amount" name="amount" required/>
        <br>
            </div>
        </div>
