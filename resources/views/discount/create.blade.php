          ...
          <div class="card mb-6">
            ...
            <!-- FORM -->
              <div class="table-responsive p-0">
                ...
                <form action='/insertdatadiscount' method="post" id="discount">
                  @csrf
                  <div class="mb-3 ms-3 me-3">
                     ...
                     <div class="mb-3 ms-3 me-3">
                        <label for="order_id" class="form-label" required>Product Id</label>
                        <br>
                     ...
                     <div class="mb-3 ms-3 me-3">
                        ...
                        <input type="date" id="start_date" name="start_date" class="form-control" aria-label="start_date" required>
                     </div>
                     <div class="mb-3 ms-3 me-3">
                        <label type="end_date"class="form-label">End Date</label>
                        <input type="date" id="end_date" name="end_date" class="form-control" aria-label="end_date" required>
                     </div>
                     <div class="mb-3 ms-3 me-3">
                        <label type="subtotal"class="form-label">Percentage</label>
                        <input type="number" id="percentage" name="percentage" class="form-control" aria-label="percentage" required>
                     </div>
