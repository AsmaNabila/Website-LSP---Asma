...
<html lang="en">
    <head>
        ...
        <title>Cashless | Asma's Bakery</title>
    </head>
    <!-- My style -->
        ...
        <div class="row">
            ...
            <div class="card p-3">
                <div class="card-body border p-0">
                    <p>
                        <a href="/cart" class="btn btn-primary w-100 h-100 d-flex align-items-center justify-content-between" aria-expanded="true" aria-controls="collapseExample">
                    ...
                    <div class="collapse p-3 pt-0" id="collapseExample">
                        <div class="row">
                            <div class="col-8">
                                <p class="h4 mb-0">Cashless</p>
                                <div class="col-md-6">
                                    <span class="text-black">Price: </span>
                                    <span>{{ $totalBelanja }}</span> <!-- Display the totalBelanja here -->
                                </div>
                                <p class="mb-0">Ini adalah total harga yang harus anda bayar setelah belanja pada Laman dan Project Kami!</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="collapse show p-3 pt-0" id="collapseExample">
                        <div class="row">
                            <div class="col-lg-5 mb-lg-0 mb-3">
                                <p class="h4 mb-0">Keterangan</p>
                                <p class="mb-0"><span class="fw-bold">Price:</span><span class="c-green"> {{ $totalBelanja }}</span></p> <!-- Display the totalBelanja here -->
                                ...
                                <form action="/bayaraction" method="POST" id="bayar">
                                    @csrf 
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form__div">
            ...
            <div class="col-12">
                <a href="/" class="btn btn-primary payment">
                    Make Payment
                </a>
            </div>
        </div>
