            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Create Payments Data</h1>
          ...
          <div class="card mb-6">
            ...
            <!-- FORM -->
              <div class="table-responsive p-0">
                ...
                <form action='/insertdatapayments' method="post" id="payments">
                  @csrf
                  <div class="mb-3 ms-3 me-3">
                     ...
                     <div class="mb-3 ms-3 me-3">
                        ...
                        <input type="date" name="payment_date" id="payment_date" class="form-control"aria-label="paymentdate" required>
                     </div>
                     <div class="mb-3 ms-3 me-3">
                        <label type="payments"class="form-label" required>Payment Method</label>
                        <select name="payment_method" class="form-control" id="'payment_method'," required>-- Pilih Payment Method --
