                                            ...
                                            <div class="card border-1 m-3 pt-3">
                                                <form action="/insertdata" method="POST" id="frmUser">
                                                    ...
                                                    <div class="mb-3 ms-3 me-3">
                                                        ...
                                                        <input type="text" name="name" id="name" class="form-control" placeholder="masukkan nama anda" aria-label="name" >
                                                    </div>
                                                    <div class="mb-3 ms-3 me-3">
                                                ...
                                                <div class="row align-items-center justify-content-lg-between">
                                                    <div class="col-lg-6 mb-lg-0 mb-4">
                                                        <div
                                                            ...
                                                            <a href="/landingpage" class="font-weight-bold"
                                                                target="_blank"> Asma's Bakery</a>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <ul
