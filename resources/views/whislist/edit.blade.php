            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Edit Wishlist</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Wishlist / Edit</li>
                        </ol>
                        <!-- <div class="row"> -->
                        <!-- Table -->
          ...
          <div class="card mb-6">
            ...
            <!-- FORM -->
              <div class="table-responsive p-0">
                ...
                <form action="{{route('whislist.update', $wishlist)}}" method="POST" id="wishlist">
                @method('PUT')
                @csrf
                ...
                <div class="mb-3 ms-3 me-3">
                    ...
                    <select name="product_id" id="product_id" class="form-control" required>
                     ...
                     <div class="row ms-3 me-3 justify-content-end">
                            <div class="col-3">
                                <a href="{{ route('whislist.index') }}" class="btn btn-danger">Cancel</a>
