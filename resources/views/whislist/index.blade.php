            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Wishlist Asma's Bakery</h1>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <a href="{{route('whislist.create')}}" class="btn btn-primary mb-2">
                                Tambah
                            </a>
                                        ...
                                        <td>
                                            ...
                                            <td>
                                                <div class="btn-group me-2">
                                                    <a href="{{ route('whislist.edit', $data) }}" class="btn btn-primary btn btn-outline-primar btn-sm">Edit</a>
                                                    <a href="/hapuswishlist/{{$data->id}}" class="btn btn-danger btn btn-outline-primar btn-sm">Delete</a>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
