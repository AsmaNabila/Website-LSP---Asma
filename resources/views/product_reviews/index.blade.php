            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <a href="{{route('product_reviews.create')}}" class="btn btn-primary mb-2">
                                Tambah
                            </a>
                        <table class="table table-hover table-bordered table-stripped" id="product_reviews">
                        <thead>
                        <tr>
                            <th>No.</th>
                            <th>Customer Id</th>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="btn-group me-2">
                                                                    <a href="{{ route('product_reviews.edit', $data) }}"
                                                                        class="btn btn-primary btn btn-outline-primar btn-sm">Ubah</a>
                                                                    <a href="/hapuspreviews/{{$data->id}}" class="btn btn-danger btn btn-outline-primar btn-sm">Hapus</a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    @endforeach
