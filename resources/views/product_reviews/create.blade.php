            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Create Product Reviews</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Product Reviews / Create</li>
                        </ol>
                        <!-- <div class="row"> -->
                        <!-- Table -->
          ...
          <div class="card mb-6">
            ...
            <!-- FORM -->
              <div class="table-responsive p-0">
                ...
                <form action='/insertdatapreviews' method="post" id="product_reviews">
                  @csrf
                  <div class="mb-3 ms-3 me-3">
                     ...
                     <div class="mb-3 ms-3 me-3">
                        ...
                        <input type="number" id="rating" name="rating" class="form-control" aria-label="rating">
                     </div>
                     <div class="mb-3 ms-3 me-3">
                        <label type="text" class="form-label hidden">Comment</label>
                        <textarea rows="5" name="comment" id="comment" class="form-control" placeholder="tuliskan komentar disini" aria-label="name"></textarea>
                     </div>
