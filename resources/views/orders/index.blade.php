            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <a href="{{route('orders.create')}}" class="btn btn-primary mb-2">
                                Tambah
                            </a>
                            <div class="card">
                      ...
                      <td>
                        ...
                        {{$idx + 1 . ". "}}
                            ...
                            <div class="btn-group me-2">
                                <a href="{{route('orders.edit',$data)}}" class="btn btn-primary btn btn-outline-primar btn-sm">Ubah</a>
                                <a href="/hapusorders/{{$data->id}}" class="btn btn-danger btn btn-outline-primar btn-sm">Hapus</a>
                            </div>
                            </td>
