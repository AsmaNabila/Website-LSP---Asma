            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Create Orders</h1>
          ...
          <div class="card mb-6">
            ...
            <!-- FORM -->
              <div class="table-responsive p-0">
                ...
                <form action="/insertdataorders" method="POST" id="orders">
                  @csrf
                    <div class="mb-3 ms-3 me-3">
                     ...
                     <div class="mb-3 ms-3 me-3">
                        <label type="nama" class="form-label">Order Date</label>
                        <input type="date" name="order_date" id="date" class="form-control"  aria-label="date" required>
                     </div>
                     <div class="mb-3 ms-3 me-3">
                        <label type="totalamount"class="form-label">Total Amount</label>
                        <input type="totalamount" id="password" name="total_amount" class="form-control" placeholder="masukkan total amount anda" aria-label="totalamount" required>
                     </div>
                     <div class="mb-3 ms-3 me-3">
